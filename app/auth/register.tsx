...
const Register = () => {
  ...
  return (
    <SafeAreaView style={tw`mx-5 mt-20`}>
      ...
      <ButtonPrimary title="Register" bgBtn="#4285F4" bgText="white" rute="./survey" />
      
      <View style={tw`flex flex-row justify-center mt-2`}>
        <ThemedText style={tw`text-sm text-center text-gray-400`}>Udah Punya Akun? </ThemedText>
        <TouchableOpacity onPress={ () => navigation.navigate('/auth/login')}>
          <ThemedText style={tw`text-sm text-center text-blue-500`}>Login</ThemedText>
        </TouchableOpacity>
      </View>
